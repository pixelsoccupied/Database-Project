<?php
  ...
  session_start();
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT ID, Password FROM Client WHERE ID = '$myusername' and  Password = '$mypassword'";
  ...
  <div class=container>
    ...
    <div align = "center">
     <div style = "width:500; border: solid 1px #333333; " align = "center">
      <div style = "background-color:#333333; color:#FFFFFF; padding:5px;"><b>Client Login</b></div>
